...
for(let event of data.events){
    ...
    if (eventDate > currentDate) {
        ...
        upcomingEvents+=`<div class="card d-flex justify-content-center shadow p-3 mb-5 bg-body-tertiary rounded">
...
document.querySelector('section.section-cards').innerHTML += upcomingEvents;
